...
//        material.set("Color", false)
    ...
    lazy var torus: Mesh = {
        let mesh = Mesh(geometry: TorusGeometry(radius: (0.5, 2.0), res: (4, 4)), material: depthMaterial)
        mesh.label = "Torus"
//        mesh.position = [2, -2, -2]
...
//        mesh.orientation = simd_quatf(angle: Float.pi * 0.25, axis: normalize([1, 1, 1]))
    ...
    lazy var ring2: Mesh = {
        let mesh = Mesh(geometry: RingGeometry(radius: (0.5, 2.0), res: (60, 4), percent: 0.3, startAngle: 0.4), material: depthMaterial)
        mesh.label = "Torus"
//        mesh.position = [2, -2, -2]
//        mesh.orientation = simd_quatf(angle: Float.pi * 0.25, axis: normalize([1, 1, 1]))
        mesh.position = [0, 0, 0]
    ...
    lazy var ring3: Mesh = {
        let mesh = Mesh(geometry: RingGeometry(radius: (1.2, 2.0), res: (60, 4), percent: 0.2, startAngle: 0.7), material: depthMaterial)
        mesh.label = "Torus"
//        mesh.position = [2, -2, -2]
//        mesh.orientation = simd_quatf(angle: Float.pi * 0.25, axis: normalize([1, 1, 1]))
        mesh.position = [0, 0, 0]
    ...
    lazy var ring4: Mesh = {
        let mesh = Mesh(geometry: RingGeometry(radius: (0.7, 2.0), res: (60, 4), percent: 0.1, startAngle: 0.9), material: depthMaterial)
        mesh.label = "Torus"
//        mesh.position = [2, -2, -2]
//        mesh.orientation = simd_quatf(angle: Float.pi * 0.25, axis: normalize([1, 1, 1]))
        mesh.position = [0, 0, 0]
...
//        let mesh = Mesh(geometry: CylinderGeometry(size: (0.5, 2.0), res: (60, 1, 1)), material: depthMaterial)
        // 
        // res 后面是分辨率
        let mesh = Mesh(geometry: CylinderGeometry(size: (1, 1), res: (3, 1, 1)), material: depthMaterial)
...
//        mesh.orientation = simd_quatf(angle: -Float.pi * 0.25, axis: normalize([0.5, 1, 1]))
    ...
    lazy var pie: Mesh = {
        let mesh = Mesh(geometry: PieGeometry(size: (1, 0.5), res: (3, 1, 1), piePersentage: 0.4, startAngle: 0), material: depthMaterial)
        //
        // res 后面是分辨率
//        let mesh = Mesh(geometry: CylinderGeometry(size: (1, 1), res: (60, 1, 1)), material: depthMaterial)
        //func setupData(size: (radius: Float, height: Float), res: (angular: Int, radial: Int, vertical: Int)) {
        mesh.label = "Cylinder"
//        mesh.position = [-2, 2, 2]
        mesh.position = [0, 0, 0]
//        mesh.orientation = simd_quatf(angle: -Float.pi * 0.25, axis: normalize([0.5, 1, 1]))
    ...
    lazy var pie2: Mesh = {
        let mesh = Mesh(geometry: PieGeometry(size: (1.2, 0.5), res: (60, 1, 1), piePersentage: 0.2, startAngle: 0.4), material: depthMaterial)
        //
        // res 后面是分辨率
//        let mesh = Mesh(geometry: CylinderGeometry(size: (1, 1), res: (60, 1, 1)), material: depthMaterial)
        //func setupData(size: (radius: Float, height: Float), res: (angular: Int, radial: Int, vertical: Int)) {
...
//        mesh.orientation = simd_quatf(angle: -Float.pi * 0.25, axis: normalize([0.5, 1, 1]))
    ...
    lazy var pie3: Mesh = {
        let mesh = Mesh(geometry: PieGeometry(size: (0.8, 0.5), res: (60, 1, 1), piePersentage: 0.6, startAngle: 0.4), material: depthMaterial)
        //
        // res 后面是分辨率
//        let mesh = Mesh(geometry: CylinderGeometry(size: (1, 1), res: (60, 1, 1)), material: depthMaterial)
        //func setupData(size: (radius: Float, height: Float), res: (angular: Int, radial: Int, vertical: Int)) {
